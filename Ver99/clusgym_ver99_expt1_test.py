...
class MCSEnv(gym.Env):
    ...
    def save_episode(self):
        save_path = os.path.join(self.history_dir, '%d_%f_%f_%f_%d_%d.npz' %(self.episodes, self.minima['energies'][self.min_idx],
                                                                   self.initial_energy, self.episode_reward, self.n_tot_all_minima, self.n_lower_energy_minima))
    ...
    def save_traj(self):      
        save_path = os.path.join(self.traj_dir, '%d_%f_%f_%f_%d_%d_full.traj' %(self.episodes, self.minima['energies'][self.min_idx]
                                                                      , self.initial_energy, self.episode_reward, self.n_tot_all_minima, self.n_lower_energy_minima))
        episode_min_path = os.path.join(self.episode_min_traj_dir, '%d_%f_%f_%f_%d_%d_full.traj' %(self.episodes, self.minima['energies'][self.min_idx]
                                                                      , self.initial_energy, self.episode_reward, self.n_tot_all_minima, self.n_lower_energy_minima))
